...
- **[GEO/AEO Tracker](https://organikpi.com/tools/geo-aeo-tracker/)** – Free, open-source, local-first dashboard that scores your brand's visibility across 6 AI models (ChatGPT, Perplexity, Gemini, Copilot, Google AI Overview, Grok) into a single 0-100 visibility score, with citation tracking and competitor battlecards. Bring your own API keys, your data stays on your machine. MIT licensed.
