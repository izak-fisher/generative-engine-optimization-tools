...
- **[Fix72 GEO Stack](https://github.com/dilm-seo/depannagelemans)** – Open-source GEO implementation for a local business (French IT repair service, Le Mans): `llms.txt`, SSR prerendering (React+Vite), LocalBusiness JSON-LD, thematic sitemaps, and Google Indexing API multi-source automation. Free, self-hosted, production-ready. Live at https://fix72.com
