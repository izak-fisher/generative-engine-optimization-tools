...
- **[friendly4AI](https://friendly4.ai)** – GEO Scanner that scores a website's AI-Readiness (whether AI can crawl, parse and understand it; free, no account) and AI Visibility (whether ChatGPT, Gemini, Claude & Perplexity actually recommend it); 40+ GEO/AEO parameters with evidence-based, prioritized fixes.
